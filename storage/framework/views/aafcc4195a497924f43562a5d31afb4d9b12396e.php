        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1"
                    data-aos="fade-up">
                    <div>
                        <h1>Donasikan Sebagian Hartamu</h1>
                        <button href="/donasi" class="btn btn-primary text-center fw-bold">Mari Berdonasi</button>
                        
                    </div>
                </div>
                <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img"
                    data-aos="fade-up">
                    <img src="<?php echo e(asset('frontend/img/berbagi.jpg')); ?>" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="features" class="features">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>App Features</h2>
                    <p>Website ini bertujuan untuk membantu teman-teman kita yang sedang mengalami kesulitan dengan cara
                        mengumpulkan para donatur untuk bersama-sama mengumpulkan dana yang dapat membantu teman-teman kita
                        yang sedang membutuhkan.</p>
                </div>
                ...
                <div class="row no-gutters">
                        ...
                        <div class="content d-flex flex-column justify-content-center">
                            <div class="row">
                                <div class="col-md-6 icon-box" data-aos="fade-up">
                                    ...
                                    <h4>Berbagi</h4>
                                    <p>Berbagi untuk dengan kasih untuk membantu teman-teman kita.</p>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                    <i class="bi bi-clock"></i>
                                    <h4>Tanpa Batas</h4>
                                    <p>Kita dapat berbagi tanpa adanya batas waktu dan ruang.</p>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                                    <i class="bi bi-cash-stack"></i>
                                    <h4>Penggalangan Dana</h4>
                                    <p>Pengumpulan dana untuk bantuan tepat sasaran.</p>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-shield-check"></i>
                                    <h4>Aman</h4>
                                    <p>Informasi dan data user tersimpan aman.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2"
                        ...
                        <img src="<?php echo e(asset('frontend/img/berbagi3.jpg')); ?>" class="img-fluid" alt=""
                            style="width: 300px">
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="<?php echo e(asset('frontend/img/details-1.png')); ?>" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="<?php echo e(asset('frontend/img/details-2.png')); ?>" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="<?php echo e(asset('frontend/img/details-3.png')); ?>" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="<?php echo e(asset('frontend/img/details-4.png')); ?>" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Contact</h2>
                    <p>Anda dapat berdiskusi dengan kami di kontak yang sudah tertera di bawah berikut ini.</p>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6 info">
                                <i class="bx bx-map"></i>
                                <h4>Address</h4>
                                <p>Telkom University,<br>Jl. Telekomunikasi No.1,<br>Terusan
                                    Buahbatu-Bojongsoang,<br>Kabupaten Bandung, Jawa Barat</p>
                            </div>
                            <div class="col-lg-6 info">
                                <i class="bx bx-phone"></i>
                                <h4>Call Us</h4>
                                <p>+62 812 7731 8312<br>+62 854 8923 9901</p>
                            </div>
                            <div class="col-lg-6 info">
                                <i class="bx bx-envelope"></i>
                                <h4>Email Us</h4>
                                <p>celengankebaikan@gmail.com<br>infoberbagi@gmail.com</p>
                            </div>
                            <div class="col-lg-6 info">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI40307_CelenganKebaikan\webdonasi-master\resources\views/welcome.blade.php ENDPATH**/ ?>