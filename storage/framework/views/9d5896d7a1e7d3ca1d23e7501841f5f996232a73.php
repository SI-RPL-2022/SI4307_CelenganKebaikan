...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>Celengan<span class="text-primary">Kebaikan</span></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?php echo e(route('daftar')); ?>" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="name" placeholder="Namamu">
...
<?php /**PATH C:\xampp\htdocs\SI40307_CelenganKebaikan\webdonasi-master\resources\views/auth/register.blade.php ENDPATH**/ ?>